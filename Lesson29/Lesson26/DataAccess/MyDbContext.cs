...
namespace Lesson26.DataAccess
{
    public class MyDbContext : DbContext
    {
        ...
        //Base64 - это стандарт кодирования бинарных данных, таких как изображения, аудио и видеофайлы,
        //в текстовую форму для передачи и хранения данных в Интернете и других сетях.
        //Стандарт Base64 определяет 64-символьный алфавит, который состоит из букв латинского алфавита(в верхнем и нижнем регистре),
        //цифр и символов "+" и "/". Каждому байту данных, которые мы хотим закодировать, соответствует 6-битный блок в кодированном виде.
